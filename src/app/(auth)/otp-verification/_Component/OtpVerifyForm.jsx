...
export default function VerifyOtpForm() {
  ...
  return (
    <div className="relative text-primary-black bg-white !p-10">
      <div className="mx-auto !w-full  flex items-center justify-center">
        <InputOTP maxLength={6} pattern={REGEXP_ONLY_DIGITS} onChange={(value) => setValue(value)}>
      ...
      {/* <div className="mx-auto my-2 max-w-max">
        <Button variant="link" disabled={resendOtpLoading} onClick={handleResendOtp} className="">
          Resend Otp
        </Button>
      </div> */}
