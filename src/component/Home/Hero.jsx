...
export default function Hero() {
  return (
    <div className=" max-w-[95%] !mt-[70px] md:!mt-0 !mx-auto h-[calc(100vh-70px)] flex justify-center bg-[#F4EBD3] md:rounded-[100px] rounded-2xl overflow-hidden">
      <div className="flex flex-col justify-center items-center w-full">
        {/* Top Text */}
        <div className="!p-6 md:!p-10">
          <Animatetext y={20} duration={1}>
            <h1
              className="text-4xl md:text-7xl lg:text-9xl font-bold text-foreground !mb-2 text-center md:!mt-10 !mt-24"
        ...
        {/* Image & Text Section */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full px-4 md:!px-8 !-mt-10 md:!mt-0">
          {/* Left Text */}
          <div className="flex justify-center items-center !p-6 md:!p-10 md:!space-y-5">
            <div className="!space-y-4">
              ...
              {/* button*/}
              <Link href="/product" className="!z-20 md:block hidden">
                <button
          ...
          <div className="relative flex justify-center items-center">
            ...
            <motion.div
              className={`animate-pulse hover:animate-none hover:scale-105 transition-all duration-700 
                        !px-4 md:!px-6 absolute top-1/3 md:left-0 left-15 -translate-x-1/2 -translate-y-1/2 z-20 
              ...
              viewport={{ once: false }}
            >
              <h1 className="text-xl md:text-6xl !mt-3 font-bold text-foreground">
            ...
            <motion.div
              ...
              className={`!px-4 md:!px-6 animate-pulse hover:animate-none hover:scale-105 transition-all duration-700 
                absolute bottom-1/3 md:right-0 right-15 translate-x-1/2 translate-y-1/2 z-20 
                flex flex-col items-center justify-center gap-1 !py-3 md:!py-4 
            ...
            {/* Image Slider */}
            <div className="w-full  md:max-w-xl !mx-auto !-mt-[90px]">
